...
- (BOOL)RAWL_SetNatInfo:(NSString *)strSharingDeviceName PrimaryDeviceName:(NSString *)strPrimaryDeviceName PrimaryUserDefinedName:(NSString *)strPrimaryUserDefinedName PrimaryServiceKey:(NSString *)strPrimaryServiceKey EnabledInternetSharing:(BOOL)bEnabledInternetSharing;
