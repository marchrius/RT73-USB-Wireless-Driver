...
BOOL SetNatInfo(NSString *strSharingDeviceName, NSString *strPrimaryDeviceName, NSString *strPrimaryUserDefinedName, NSString *strPrimaryServiceKey, BOOL bEnabledInternetSharing);
